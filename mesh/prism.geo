...
Transfinite Line {1,2,3,4,5,6,7,8,9} = layers;
...
*/
Recombine Surface {11,13,15};// Gmsh project created on Tue Nov  9 15:21:42 2021
//+
Physical Volume("Domain") = {21};
//+
Physical Surface("Surfaces") = {19, 13, 15, 11, 17};
