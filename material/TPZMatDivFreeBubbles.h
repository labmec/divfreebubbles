/**
 * @file TPZMatDivFreeBubbles.h
 * @brief Contains the TPZDivFreeBubbles class which a H1 formulation for vector fields
 */

#ifndef TPZMATDIVFREEBUBBLES_H
#define TPZMATDIVFREEBUBBLES_H
...
public:
	 ...
	 */
	TPZMatDivFreeBubbles(int id, int dim);

    std::string Name() const override { return "TPZMatDivFreeBubbles"; }
