...
#ifndef TPZMixedDarcyH1_H
#define TPZMixedDarcyH1_H
...
class TPZMixedDarcyH1 : public TPZMatBase<STATE, TPZMatCombinedSpacesT<STATE>,
...
public:
	 ...
	 */
    [[maybe_unused]] TPZMixedDarcyH1(int id, int dim);

    /**
             copy constructor
     */
    TPZMixedDarcyH1(const TPZMixedDarcyH1 &copy);
    /**
             copy constructor
     */
    TPZMixedDarcyH1 &operator=(const TPZMixedDarcyH1 &copy);
    /**
	 * @brief Returns a 'std::string' with the name of the material
	 */
    [[nodiscard]] std::string Name() const override { return "TPZMixedDarcyH1"; }
